...
plot(iris, col = c("red", "blue", "#ddaa33")[iris$Species], 
     pch = c(1, 2, 3)[iris$Species], cex = 0.8)
```
...
appropriate plot for the data provided.
...
As well as the ```plot()``` function R has some sepcific plot functions (box plots (boxplot()), histograms (hist()) and bar plots (barplot()))
